...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string>[] = [
    { stimulus: 'There are two ways to get $5 from Mr. Johnson: mowing his lawn or cleaning his gutters. Laura believes Mr. Johnson will only give you $5 for mowing his lawn. Laura tells you: “If you mow Mr. Johnson’s lawn, he’ll pay you $5.”', prompt: '<p>Do you think Laura would accept the following statement: <b>“If you don’t mow Mr. Johnson’s lawn, he won’t pay you $5.”</b></p>'},
    { stimulus: 'There are two ways to get $5 from Mr. Johnson: mowing his lawn or cleaning his gutters. Laura knows that Mr. Johnson will give you $5 for both mowing his lawn and cleaning his gutters. Laura tells you: “If you mow Mr. Johnson’s lawn, he’ll pay you $5.”', prompt: '<p>Do you think Laura would accept the following statement: <b>“If you don’t mow Mr. Johnson’s lawn, he won’t pay you $5.”</b></p>'},
    { stimulus: 'There are two ways to get $5 from Mr. Johnson: mowing his lawn or cleaning his gutters. Laura believes Mr. Johnson will only give you $5 for mowing his lawn. Laura tells you: “Mr. John will pay you $5 for mowing his lawn.”', prompt: '<p>Do you think Laura would accept the following statement: <b>“If you don’t mow Mr. Johnson’s lawn, he won’t pay you $5.”</b></p>'},
    { stimulus: 'There are two ways to get $5 from Mr. Johnson: mowing his lawn or cleaning his gutters. Laura knows that Mr. Johnson will give you $5 for both mowing his lawn and cleaning his gutters. Laura tells you: “Mr. John will pay you $5 for mowing his lawn.”', prompt: '<p>Do you think Laura would accept the following statement: <b>“If you don’t mow Mr. Johnson’s lawn, he won’t pay you $5.”</b></p>'},
    { stimulus: 'There are two ways Susie’s goldfish can get sick: if she stops feeding it or cleaning its tank. Susie has stopped doing either, but her father only knows that she’s stopped cleaning the goldfish’s tank. Her father tells you: “If Susie doesn’t start cleaning the fish tank, she’ll make her goldfish sick.”', prompt: '<p>Do you think Susie’s father would accept the following statement: <b>“If Susie starts cleaning the fish tank, she won’t make her goldfish sick.”</b></p>'},
    ...
    { stimulus: 'There are two ways Susie’s goldfish can get sick: if she stops feeding it or cleaning its tank. Susie has stopped doing either, but her father only knows that she’s stopped cleaning the goldfish’s tank. He tells you: “Susie will make her goldfish sick by not cleaning its tank.”', prompt: '<p>Do you think Susie’s father would accept the following statement: <b>“If Susie starts cleaning the fish tank, she won’t make her goldfish sick.”</b></p>'},
    ...
    { stimulus: 'Billy and Susie were both throwing rocks at Mrs. Smith’s vase. However, Mrs. Smith only saw Billy throwing rocks. Mrs. Smith tells you: “Billy will break my vase by throwing rocks.”', prompt: '<p>Do you think Mrs. Smith would accept the following statement: <b>“If Billy stops throwing rocks at her vase, it won’t break.”</b></p>'},
    { stimulus: 'Billy and Susie were both throwing rocks at Mrs. Smith’s vase. However, Mrs. Smith saw both Billy and Susie throwing rocks. Mrs. Smith tells you: “Billy will break my vase by throwing rocks.”', prompt: '<p>Do you think Mrs. Smith would accept the following statement: <b>“If Billy stops throwing rocks at her vase, it won’t break.”</b></p>'},
    { stimulus: 'Billy and Susie were both throwing rocks at Mrs. Smith’s vase. However, Mrs. Smith only saw Billy throwing rocks. Mrs. Smith tells you: “If Billy keeps throwing rocks, he will break my vase.”', prompt: '<p>Do you think Mrs. Smith would accept the following statement: <b>“If Billy stops throwing rocks at her vase, it won’t break.”</b></p>'},
    { stimulus: 'Billy and Susie were both throwing rocks at Mrs. Smith’s vase. However, Mrs. Smith saw both Billy and Susie throwing rocks. Mrs. Smith tells you: “If Billy keeps throwing rocks, he will break my vase.”', prompt: '<p>Do you think Mrs. Smith would accept the following statement: <b>“If Billy stops throwing rocks at her vase, it won’t break.”</b></p>'},
    { stimulus: 'There are two ways John’s eucalyptus tree can die: if it isn’t watered frequently, or if it doesn’t receive enough sunlight. John’s plant sitter has watered the tree infrequently and placed it in the shade. John only knows that the eucalyptus tree has been watered infrequently. John tells you: “If my plant-sitter doesn’t water my eucalyptus tree more often, it will die.”', prompt: '<p>Do you think John would accept the following statement: <b>“If my plant-sitter doesn’t water my eucalyptus tree more often, it will die.”</b></p>'},
    { stimulus: 'There are two ways John’s eucalyptus tree can die: if it isn’t watered frequently, or if it doesn’t receive enough sunlight. John’s plant-sitter has watered the tree infrequently and placed it in the shade. John knows that the plant-sitter has done both of these things. John tells you: “If my plant-sitter doesn’t water my eucalyptus tree more often, it will die.”', prompt: '<p>Do you think John would accept the following statement: <b>“If my plant-sitter doesn’t water my eucalyptus tree more often, it will die.”</b></p>'},
    { stimulus: 'There are two ways John’s eucalyptus tree can die: if it isn’t watered frequently, or if it doesn’t receive enough sunlight. John’s plant sitter has watered the tree infrequently and placed it in the shade. John only knows that the eucalyptus tree has been watered infrequently. John tells you: “My plant-sitter will kill the eucalyptus tree by watering it infrequently.”', prompt: '<p>Do you think John would accept the following statement: <b>“If my plant-sitter doesn’t water my eucalyptus tree more often, it will die.”</b></p>'},
    { stimulus: 'There are two ways John’s eucalyptus tree can die: if it isn’t watered frequently, or if it doesn’t receive enough sunlight. John’s plant-sitter has watered the tree infrequently and placed it in the shade. John knows that the plant-sitter has done both of these things. John tells you: “My plant-sitter will kill the eucalyptus tree by watering it infrequently.”', prompt: '<p>Do you think John would accept the following statement: <b>“If my plant-sitter doesn’t water my eucalyptus tree more often, it will die.”</b></p>'},
    { stimulus: 'There are two ways Bert can annoy Ernie: he can tap his foot and he can hum. Oscar sees that Bert is currently doing both. Oscar tells you: “Bert tapping his foot will annoy Ernie.”', prompt: '<p>Do you think Oscar would accept the following statement: <b>“If Bert stops tapping his foot, Ernie won’t be annoyed.”</b></p>'},
    { stimulus: 'There are two ways Bert can annoy Ernie: he can tap his foot and he can hum. Bert is currently doing both, but Oscar only sees Bert tapping his foot. Oscar tells you: “Bert tapping his foot will annoy Ernie.”', prompt: '<p>Do you think Oscar would accept the following statement: <b>“If Bert stops tapping his foot, Ernie won’t be annoyed.”</b></p>'},
    { stimulus: 'There are two ways Bert can annoy Ernie: he can tap his foot and he can hum. Oscar sees that Bert is currently doing both. Oscar tells you: “If Bert doesn’t stop tapping his foot, Ernie will be annoyed.”', prompt: '<p>Do you think Oscar would accept the following statement: <b>“If Bert stops tapping his foot, Ernie won’t be annoyed.”</b></p>'},
    { stimulus: 'There are two ways Bert can annoy Ernie: he can tap his foot and he can hum. Bert is currently doing both, but Oscar only sees Bert tapping his foot. Oscar tells you: “If Bert doesn’t stop tapping his foot, Ernie will be annoyed.”', prompt: '<p>Do you think Oscar would accept the following statement: <b>“If Bert stops tapping his foot, Ernie won’t be annoyed.”</b></p>'},
  ]
